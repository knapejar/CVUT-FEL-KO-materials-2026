...
- [ ] K1: L1.1–L1.15 — L1.1, L1.2 po korektuře; L1.3 po korektuře; L1.4 napsána tvůrcem (čeká kritik); viz.js: přidán `labelAt` u lpRegion constraints + posun popisku objective šipky; oprava lpRegion: dedupe průsečíků hraniční čáry procházející rohy okna (jinak se čára+popisek nevykreslí — ukázka 4b ve viz-gallery)
...
- L1.2 obsahuje dopředné odkazy na l1-3.html, l1-4.html a l1-14.html (sériový workflow). l1-3.html už existuje a titulek sedí ✓; po dopsání L1.14 ověřit zbylé. l1-4.html už existuje (titulek sedí ✓). L1.4 má dopředné odkazy na l1-5.html (pager) a l1-8.html (řešení T02 — modelování maxima).
