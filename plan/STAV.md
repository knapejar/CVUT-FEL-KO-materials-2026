...
- [ ] K1: L1.1–L1.15 — L1.1, L1.2 po korektuře; L1.3 po korektuře; L1.4 po korektuře; L1.5 po korektuře; L1.6 po korektuře; L1.7 po korektuře; L1.8 po korektuře; L1.9 po korektuře; L1.10 po korektuře; L1.11 po korektuře; L1.12 po korektuře; L1.14 napsána tvůrcem (Toys assignment [FOTO] — posun indexu pro „hned vlevo/vedle“, okrajové pojistky, zákaz pozic vynulováním, disjunkce svědků součtem + big-M alternativa se selektory $y_1,y_2$, most na perfect matching/K4; čeká kritik); L1.13 po korektuře (big-M konstanta přejmenována na $K$ — symbol $M$ je v zadání lunch menu obsazený množinou jídel; doplněn předpoklad $p_m \ge 0$ u volby $K = \max_m p_m$); viz.js: přidán `labelAt` u lpRegion constraints + posun popisku objective šipky; oprava lpRegion: dedupe průsečíků hraniční čáry procházející rohy okna (jinak se čára+popisek nevykreslí — ukázka 4b ve viz-gallery); přidán `KOViz.fnPlot` (graf funkce po úsecích — nespojité fce, ukázka 4c ve viz-gallery, použit v L1.6); fnPlot: přidán `xmin` (záporný rozsah osy x + čárkovaná svislice v x=0 — ukázka 4d ve viz-gallery, použit v L1.10)
